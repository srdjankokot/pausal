...
const Color pastelBlue = Color(0xFF8AAEF2);
const Color pastelBlueDark = Color(0xFF4F6FDB);
const Color pastelBlueLight = Color(0xFFE6ECFF);
const Color darkNavy = Color(0xFF1E2749);
